...
class OrderController {
    ...
    ResponseEntity<ResourceSupport> cancel(@PathVariable Long id) throws URISyntaxException {
        ...
        if (order.getStatus() == Status.IN_PROGRESS) {
            ...
            throw new OrderMethodNotAllowedException(order.getStatus());
        }
    }

    @PutMapping("/orders/{id}/complete")
    ResponseEntity<ResourceSupport> complete(@PathVariable Long id) throws URISyntaxException{
